...
<div class="offcanvas offcanvas-start sidebar text-white" tabindex="-1" id="sidebar">
      ...
      <?php if ($tipoUsuario !== 'cliente'): ?>
        ...
        <div class="mt-2">
          <a class="d-flex justify-content-between align-items-center text-white text-decoration-none"
             data-bs-toggle="collapse" href="#submenuLibros" role="button" aria-expanded="false" aria-controls="submenuLibros">
        ...
        <div class="mt-2">
          <a class="d-flex justify-content-between align-items-center text-white text-decoration-none"
             data-bs-toggle="collapse" href="#submenuReservas" role="button" aria-expanded="false" aria-controls="submenuReservas">
            <span>Reservas</span>
            <span class="small">▼</span>
          </a>
        ...
        <div class="mt-2">
          <a class="d-flex justify-content-between align-items-center text-white text-decoration-none"
             data-bs-toggle="collapse" href="#submenuPrestamos" role="button" aria-expanded="false" aria-controls="submenuPrestamos">
            <span>Préstamos</span>
            <span class="small">▼</span>
          </a>
        ...
        <div class="mt-2">
  <a class="d-flex justify-content-between align-items-center text-white text-decoration-none"
     data-bs-toggle="collapse" href="#submenuReportes" role="button" aria-expanded="false" aria-controls="submenuReportes">
    <span> Reportes</span>
    <span class="small">▼</span>
  </a>
  ...
  <div class="collapse submenu mt-1" id="submenuReportes">
    ...
    <a class="d-flex justify-content-between align-items-center text-white text-decoration-none ps-3"
       data-bs-toggle="collapse" href="#submenuExcel" role="button" aria-expanded="false" aria-controls="submenuExcel">
      <span>Excel</span>
      <span class="small">▼</span>
    </a>
    <div class="collapse submenu mt-1" id="submenuExcel">
      <a href="views/reporte_inventario.php" class="d-block py-1">Inventario</a>
      <a href="views/reporte_prestamos.php" class="d-block py-1">Préstamos</a>
    </div>

    <a class="d-flex justify-content-between align-items-center text-white text-decoration-none ps-3 mt-2"
       data-bs-toggle="collapse" href="#submenuPDF" role="button" aria-expanded="false" aria-controls="submenuPDF">
      <span>PDF</span>
      <span class="small">▼</span>
    </a>
    <div class="collapse submenu mt-1" id="submenuPDF">
      <a href="views/export_inventario_pdf.php" class="d-block py-1">Inventario</a>
      <a href="views/export_prestamos_pdf.php" class="d-block py-1">Préstamos</a>
    </div>
...
<?php if ($tipoUsuario === 'cliente' && ($_GET['section'] ?? '') === 'perfil'): ?>
    <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($nombre && $apellido && $email) {
            ...
            if ($resultCheck->num_rows > 0) {
                $message = "⚠️ Este correo ya está en uso.";
            } else {
                if ($password !== '') {
                ...
                <div class="card book-card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-3 text-end">
                            <a href="views/info_libro.php?id=<?= urlencode($book['id']) ?>" class="btn btn-outline-primary rounded-pill px-3">
                                Más información
                            </a>
                        </div>
                    </div>
