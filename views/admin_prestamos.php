...
function cambiarEstado(id, accion) {
    const mensajes = {
        aceptar: {titulo: "¿Aceptar préstamo?", texto: "El libro será prestado al usuario."},
        rechazar: {titulo: "¿Rechazar préstamo?", texto: "El préstamo será cancelado."},
        devolver: {titulo: "¿Marcar como devuelto?", texto: "El libro regresará al inventario."}
    };
